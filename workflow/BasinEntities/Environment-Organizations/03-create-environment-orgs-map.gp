...
CreateGeoMap(NewGeoMapID="EnvironmentOrgMap",Name="Environmental Organizations",Description="Environmental Organizations",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.46,40.01,11',docPath:'environment-orgs-map.md'")
