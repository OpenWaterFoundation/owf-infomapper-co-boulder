# Create a GeoMapProject file for basins for basin:
...
# - GeoMapID:  BasinsMap
CreateGeoMapProject(NewGeoMapProjectID="BasinsProject",ProjectType="SingleMap",Name="Boulder Creek Basins",Description="Boulder Creek Basins",Properties="author:'Open Water Foundation',specificationFlavor:'',specificationVersion:'1.0.0'")
CreateGeoMap(NewGeoMapID="BasinsMap",Name="Boulder Creek Basins",Description="Boulder Creek Basins",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.3,40.1,10',docPath:basins-map.md")
...
# HUC 2 on bottom
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/country/us/usgs/huc-basins/huc2-basin-10-missouri.geojson",GeoLayerID="HUC2BasinLayer",Name="HUC2 Basin: 10, Missouri",Description="HUC2 Basin boundaries from the USGS")
...
# HUC 4 next on top
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/country/us/usgs/huc-basins/huc4-basin-1019-south-platte.geojson",GeoLayerID="HUC4BasinLayer",Name="HUC4 Basin: 1019, Platte",Description="HUC4 Basin boundaries from the USGS")
...
# HUC 8 next on top
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/country/us/usgs/huc-basins/huc8-basin-10190005-saint-vrain.geojson",GeoLayerID="HUC8BasinLayer",Name="HUC8 Basin: 10190005, Saint Vrain",Description="HUC8 Basin boundaries from the USGS")
AddGeoLayerViewToGeoMap(GeoLayerID="HUC8BasinLayer",GeoLayerViewID="HUC8BasinsLayerView",Name="HUC8 Basin: 10100005, Saint Vrain",Description="HUC8 Basin boundaries from the USGS",InsertPosition="Top",Properties="docPath:layers/huc8.md")
...
# HUC 10 next on top
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/country/us/usgs/huc-basins/huc10-basins-10190005-saint-vrain.geojson",GeoLayerID="HUC10BasinLayer",Name="Saint Vrain HUC10 Basins",Description="HUC10 Basin boundaries from the USGS")
AddGeoLayerViewToGeoMap(GeoLayerID="HUC10BasinLayer",GeoLayerViewID="HUC10BasinsLayerView",Name="Saint Vrain HUC10 Basins",Description="HUC10 Basin boundaries from the USGS",InsertPosition="Top",Properties="docPath:layers/huc10.md,highlightEnabled:true")
...
AddGeoLayerViewToGeoMap(GeoLayerID="HUC12BasinLayer",GeoLayerViewID="HUC12BasinsLayerView",Name="Saint Vrain HUC 12 Basins",Description="HUC12 Basin boundaries from the USGS",InsertPosition="Top",Properties="docPath:layers/huc12.md,highlightEnabled:true")
...
#
CopyFile(SourceFile="../Physical-StreamReaches/layers/stream-reaches.md",DestinationFile="layers/stream-reaches.md")
ReadGeoLayerFromGeoJSON(InputFile="https://data.openwaterfoundation.org/state/co/dwr/stream-reaches/co-stream-reaches-district5.geojson",GeoLayerID="StreamReachesLayer",Name="Stream Reaches",Description="Stream Reaches")
