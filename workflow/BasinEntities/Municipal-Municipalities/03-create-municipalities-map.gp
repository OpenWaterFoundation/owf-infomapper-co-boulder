...
CreateGeoMap(NewGeoMapID="MunicipalitiesMap",Name="Municipalities",Description="Municipalities",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.46,40.01,11',docPath:'municipalities-map.md'")
...
#CopyFile(SourceFile="../Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-6-event-config.json",DestinationFile="layers/co-dwr-water-district-6-event-config.json")
