...
AddGeoLayerViewToGeoMap(GeoLayerID="WaterDistrictLayer",GeoLayerViewID="WaterDistrictLayerView",Name="CO DWR Water District 6",Description="Water District 6 boundary from the Colorado Division of Water Resources",Properties="docPath:../Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-6.md",InsertPosition="Top")
...
SetGeoLayerViewCategorizedSymbol(GeoLayerViewID="StateHouseDistrictsLayerView",Name="Colorize state house districts",Description="Show each district the same color except those that overlap the Boulder Creek basin",ClassificationAttribute="District",Properties="classificationType:'categorized',classificationFile:'layers/co-state-house-districts-2021-classify-district.csv'")
# Currently no graphs
...
SetGeoLayerViewCategorizedSymbol(GeoLayerViewID="StateSenateDistrictsLayerView",Name="Colorize state senate districts",Description="Show each district the same color except those that overlap the Boulder Creek basin",ClassificationAttribute="District",Properties="classificationType:'categorized',classificationFile:'layers/co-state-senate-districts-2021-classify-district.csv'")
# Currently no graphs
