# Create a GeoMapProject file for stream reaches:
...
CreateGeoMap(NewGeoMapID="StreamReachesMap",Name="Stream Reaches",Description="Stream Reaches",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.46,40.01,11',docPath:stream-reaches-map.md")
