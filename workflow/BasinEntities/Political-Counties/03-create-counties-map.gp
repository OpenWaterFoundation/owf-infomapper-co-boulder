# Create a GeoMapProject file for counties:
...
#CopyFile(SourceFile="../Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-6.md",DestinationFile="layers/co-dwr-water-district-6.md.json")
