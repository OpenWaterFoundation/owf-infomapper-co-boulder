# Create a GeoMapProject file for instream flow reaches for the basin:
...
CreateGeoMap(NewGeoMapID="InstreamReachesMap",Name="Instream Flow Reaches",Description="Instream Flow Reaches",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.46,40.01,11',docPath:'instream-reaches-map.md'")
