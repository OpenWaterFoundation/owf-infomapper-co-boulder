# Create a GeoMapProject file for current streamflow for the basin:
...
CreateGeoMap(NewGeoMapID="StreamflowMap",Name="Streamflow",Description="Streamflow",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.46,40.01,11',docPath:'streamflow-map.md'")
...
#CopyFile(SourceFile="layers/co-dwr-water-district-6-event-config.json",DestinationFile="${MapFolder}/layers/co-dwr-water-district-6-event-config.json")
