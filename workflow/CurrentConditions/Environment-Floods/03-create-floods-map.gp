# Create a GeoMapProject file for current flood conditions:
...
CreateGeoMap(NewGeoMapID="CurrentFloodsMap",Name="Flood Conditions",Description="Flood conditions",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.46,40.01,11',docPath:floods-map.md")
...
AddGeoLayerViewToGeoMap(GeoLayerID="CameronPeakSoilBurnSeverityRasterLayer",GeoLayerViewID="CameronPeakSoilBurnSeverityRasterLayerView",Name="Cameron Peak Fire Soil Burn Severity (raster)",Description="Cameron Peak Fire soil burn severity from USFS BAER",Properties="docPath:../Environment-Wildfires/layers/cameron-peak-sbs.md",InsertPosition="Top")
...
ReadGeoLayerFromGeoJSON(InputFile="https://mhfd-ns5data.trilynx-novastar.systems/novastar/data/api/v1/stationStatistics?dataType=WaterLevelRiver&statistic=Last&interval=1Day&format=geojson&statisticFormat=flat&statisticValueName=%24%7BdataType%7D.%24%7Binterval%7D",GeoLayerID="FloodWarningLevelStationsLayer",Name="Flood Warning System Water Level Stations",Description="Flood Warning System water level stations from Larimer County FWS")
...
# CopyFile(SourceFile="layers/co-dwr-water-district-6.md",DestinationFile="${MapFolder}/layers/co-dwr-water-district-6.md")
