...
CreateGeoMap(NewGeoMapID="CurrentSnowpackMap",Name="Current Snowpack",Description="Current snowpack",CRS="EPSG:4326",Properties="extentInitial:'ZoomLevel:-105.46,40.01,11',docPath:snowpack-map.md")
...
SetGeoLayerViewEventHandler(GeoLayerViewID="WaterDistrictLayerView",EventType="click",Name="Click event",Description="Click event configuration",Properties="eventConfigPath:../../BasinEntities/Administration-CoDwrWaterDistricts/layers/co-dwr-water-district-5-event-config.json")
# = = = = = = = = = =
