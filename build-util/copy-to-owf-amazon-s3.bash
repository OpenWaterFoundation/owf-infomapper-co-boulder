...
# Get the InfoMapper version and Boulder Creek Basin Information Portal version.
...
printUsage() {
  ...
  echoStderr ""
  echoStderr "Copy the Boulder Creek Basin Information Portal application files to the Amazon S3 static website folder(s),"
...
printVersion() {
  ...
  echoStderr ""
  echoStderr "Boulder Creek Basin Information"
...
s3FolderVersionUrl="s3://rivers.openwaterfoundation.org/state/co/boulder/${appVersion}"
s3FolderLatestUrl="s3://rivers.openwaterfoundation.org/state/co/boulder/latest"
